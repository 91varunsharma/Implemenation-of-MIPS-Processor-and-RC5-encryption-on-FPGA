...
public:
    ...
    void OutputRF() {
        ofstream rfout;
        rfout.open("/Users/ADDY/Google Drive/github/AHD-Project-2016/MIPS Simulator/RFresult_rc5_all.txt",std::ios_base::app);
        if (rfout.is_open())
        {
...
public:
    ...
    INSMem()
    {
        ...
        string line;
        int i=0;
        imem.open("/Users/ADDY/Google Drive/github/AHD-Project-2016/MIPS Simulator/IMem/imem_rc5_all.txt");
        if (imem.is_open())
        {
...
public:
    ...
    DataMem()
    {
        ...
        string line;
        int i=0;
        dmem.open("/Users/ADDY/Google Drive/github/AHD-Project-2016/MIPS Simulator/DMem/dmem_all.txt");
        if (dmem.is_open())
        {
    ...
    void OutputDataMem() {
        ofstream dmemout;
        dmemout.open("/Users/ADDY/Google Drive/github/AHD-Project-2016/MIPS Simulator/DMem/dmem_all_result.txt", std::ios_base::app);
        if (dmemout.is_open())
